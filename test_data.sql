...
-- Insert Mesas
INSERT INTO mesa (numero, disponivel) VALUES (1, true);
INSERT INTO mesa (numero, disponivel) VALUES (2, true);
INSERT INTO mesa (numero, disponivel) VALUES (3, false);
INSERT INTO mesa (numero, disponivel) VALUES (4, true);
INSERT INTO mesa (numero, disponivel) VALUES (5, true);
...
-- Pedido 4:
INSERT INTO pedido (cliente_id, data_pedido, hora_entrega, conta_id, mesa_numero) 
VALUES (4, '2024-01-15 19:20:00', NULL, NULL, 4);

-- Pedido 5:
INSERT INTO pedido (cliente_id, data_pedido, hora_entrega, conta_id, mesa_numero) 
VALUES (5, '2024-01-15 20:00:00', '2024-01-15 20:35:00', NULL, 5);

-- Pedido 6:
INSERT INTO pedido (cliente_id, data_pedido, hora_entrega, conta_id, mesa_numero) 
VALUES (1, '2024-01-15 14:00:00', '2024-01-15 14:25:00', 1, 1);
...
-- Insert Pagamentos (optional, if needed)
INSERT INTO pagamento (tipo) VALUES ('DINHEIRO');
INSERT INTO pagamento (tipo) VALUES ('CARTAO');
